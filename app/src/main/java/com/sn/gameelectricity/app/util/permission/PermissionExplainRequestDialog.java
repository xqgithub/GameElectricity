 ...
 */
public class PermissionExplainRequestDialog extends RationaleDialog {
    ...
    public PermissionExplainRequestDialog(@NonNull Context context, List<String> permissions) {
