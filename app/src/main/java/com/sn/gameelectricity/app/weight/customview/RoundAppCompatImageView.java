...
public class RoundAppCompatImageView extends AppCompatImageView {
    ...
    public RoundAppCompatImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundAppCompatImageView, defStyleAttr, 0);

        type = a.getInt(R.styleable.RoundAppCompatImageView_type, TYPE_ROUND);
        mBorderColor = a.getColor(R.styleable.RoundAppCompatImageView_border_color, Color.WHITE);
        mBorderWidth = a.getDimension(R.styleable.RoundAppCompatImageView_border_width, 0);
        mCornerRadius = a.getDimension(R.styleable.RoundAppCompatImageView_corner_radius, dp2px(10));
        mLeftTopCornerRadius = a.getDimension(R.styleable.RoundAppCompatImageView_leftTop_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimension(R.styleable.RoundAppCompatImageView_leftBottom_corner_radius, 0);
        mRightTopCornerRadius = a.getDimension(R.styleable.RoundAppCompatImageView_rightTop_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimension(R.styleable.RoundAppCompatImageView_rightBottom_corner_radius, 0);
     ...
     * 默认为圆形图片
     */
    public RoundAppCompatImageView setType(int imageType) {
     ...
     * 设置圆角图片的圆角大小
     */
    public RoundAppCompatImageView setCornerRadius(int cornerRadius) {
     ...
     * 设置圆角图片的左上圆角大小
     */
    public RoundAppCompatImageView setLeftTopCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的右上圆角大小
     */
    public RoundAppCompatImageView setRightTopCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的左下圆角大小
     */
    public RoundAppCompatImageView setLeftBottomCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置圆角图片的右下圆角大小
     */
    public RoundAppCompatImageView setRightBottomCornerRadius(int cornerRadius) {
        cornerRadius = dp2px(cornerRadius);
     ...
     * 设置描边宽度
     */
    public RoundAppCompatImageView setBorderWidth(int borderWidth) {
     ...
     * 设置描边颜色
     */
    public RoundAppCompatImageView setBorderColor(int borderColor) {
