...
//    }
    ...
    public static class HandlerHolder extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (PublicPracticalMethodFromKT.Companion.getPpmfKT().isBlank(mContext.get())) {
                return;
            }
            if (!PublicPracticalMethodFromKT.Companion.getPpmfKT().isBlank(onReceiveMessageListener) &&
                    !PublicPracticalMethodFromKT.Companion.getPpmfKT().isBlank(onReceiveMessageListener.get())) {
